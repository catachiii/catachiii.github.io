...
During my master program, I worked as an intern on reinforcement learning with unsupervised skill discovery in [Autonomous Learning group](https://al.is.mpg.de/) at <img src="../assets/img/mpi.png" alt="mpi" width="15"/> [Max Planck Institute for Intelligent Systems (MPI-IS)](https://is.mpg.de/) under the supervision of [Prof. Dr. Georg Martius](https://al.is.mpg.de/person/gmartius). 
